...
public class ImageStatusTopAdapter extends RecyclerView.Adapter<ImageStatusTopAdapter.ViewHolder> {
    Context context;
    ArrayList<String> arrayList;
    OnItemClickListener onItemClickListener;

    public ImageStatusTopAdapter(Context context, ArrayList<String> arrayList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.status_top_recyclerview_item, parent, false);
